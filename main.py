...
class MainWindow(QWidget):
    def _connect_to_db(self):
        self.conn = psycopg2.connect(database="dot",
                                     user="postgres",
                                     password="1234",
                                     host="localhost",
                                     port="5432")
    ...
    def _update_monday_table0(self):
        ...
        self.cursor.execute(
            "SELECT * FROM timetable where day = 'Понедельник';")
        records = list(self.cursor.fetchall())
    ...
    def insert_day(self):
        self.conn.rollback()
        self.cursor.execute(
            "INSERT INTO timetable (day, subject, room_numb, start_time, weekstatus) values('write here',"
